		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comahuimodule1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comahuimodule1-display": {
								"semanticObject": "comahuimodule1",
								"action": "display",
								"description": "Pollution tracker",
								"title": "Pollution tracker",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ah.uimodule1",
									"url": sap.ui.require.toUrl("com/ah/uimodule1")
								}
							}
						}
					}
