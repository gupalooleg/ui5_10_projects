		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Portfolio",
									"targetURL": "#comahuimodule2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comahuimodule2-display": {
								"semanticObject": "comahuimodule2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ah.uimodule2",
									"url": sap.ui.require.toUrl("com/ah/uimodule2")
								}
							}
						}
					}
