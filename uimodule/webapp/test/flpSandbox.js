		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 10 projects",
									"targetURL": "#comahuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comahuimodule-display": {
								"semanticObject": "comahuimodule",
								"action": "display",
								"description": "UI5 10 projects",
								"title": "UI5 10 projects",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ah.uimodule",
									"url": sap.ui.require.toUrl("com/ah/uimodule")
								}
							}
						}
					}
